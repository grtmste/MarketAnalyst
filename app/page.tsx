...
export default function Home() {
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden">
      {/* ── Header ── */}
      <header className="flex-shrink-0 flex items-center flex-wrap justify-between gap-3 px-4 py-3 bg-white border-b border-[rgba(0,0,0,0.06)] shadow-sm">
        {/* Brand */}
      ...
      {/* ── Main content ── */}
      <main className="flex-1 flex flex-col lg:flex-row overflow-y-auto lg:overflow-hidden min-h-0 p-3 gap-3">
        {/* Chart card */}
        <div className="flex-shrink-0 lg:flex-1 lg:min-h-0 h-[60vh] lg:h-auto bg-[#FAFAFA] rounded-2xl border border-[rgba(0,0,0,0.06)] shadow-card overflow-hidden">
          <TradingChart
            data={chartData}
        ...
        {/* Analysis panel */}
        <div className="flex-shrink-0 lg:w-80 xl:w-96 lg:h-full lg:overflow-hidden min-h-[400px]">
          <AnalysisPanel
            analysis={analysis}
